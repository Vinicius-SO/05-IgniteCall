...
var MultiStepContainer = (0, import_react2.styled)("div", {
  width: "100%"
});
var Label = (0, import_react2.styled)(Text, {
  color: "$gray200",
  // fontSize: '$xs',
  defaultVariants: {
    size: "xs"
...
var Steps = (0, import_react2.styled)("div", {
  display: "grid",
  gridTemplateColumns: "repeat(var(--steps-size), 1fr)",
  gap: "$2",
  marginTop: "$1"
});
var Step = (0, import_react2.styled)("div", {
  height: "$1",
  borderRadius: "$px",
  backgroundColor: "$gray600",
  variants: {
